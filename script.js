document.addEventListener('DOMContentLoaded', () => {
    ...
    const frases = ["TE AMO", "MI UNIVERSO", "ERES MI VIDA", "❤️", "SOLO TÚ", "MI ESTRELLA", "💘", "MI TODO", "SIEMPRE ESTARE CONTIGO", "MI REINA", "ERES ARTE", "✨", "MI DESTINO", "TE ADORO", "X SIEMPRE", "MI CIELO"];
    const fotos = ["img/foto1.jpg", "img/foto2.jpg", "img/foto3.jpg", "img/foto4.jpg", "img/foto5.jpg", "img/foto6.jpg", "img/foto7.jpg", "img/foto8.jpg"];
